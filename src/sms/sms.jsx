    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="icon" href="/smslogo.ico" />
                <meta name="title" content="SMS Bomber" />
                <meta property="og:title" content="SMS Bomber" />
                <meta name="description" content="Send bulk SMS effortlessly with my SMS Bomber. Choose speed options, track live status, and enjoy a seamless experience with dark/light mode support." />
                <meta property="og:description" content="Send bulk SMS effortlessly with my SMS Bomber. Choose speed options, track live status, and enjoy a seamless experience with dark/light mode support." />
                <meta name="keywords" content="SMS bomber, send bulk SMS, free SMS bomber, fast SMS bomber, SMS spammer, online SMS tool, SMS blaster, SMS attack, SMS flooder, prank SMS sender" />
            </Helmet>
